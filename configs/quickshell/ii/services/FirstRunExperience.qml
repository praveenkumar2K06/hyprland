...
Singleton {
    ...
    function load() {
        Quickshell.execDetached(["bash", "-c", `echo '${root.firstRunFileContent}'`])
    ...
    function handleFirstRun() {
        Quickshell.execDetached([Directories.wallpaperSwitchScriptPathv2, " --wall ",root.defaultWallpaperPath])
