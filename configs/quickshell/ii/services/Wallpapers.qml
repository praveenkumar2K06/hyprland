...
Singleton {
    ...
    readonly property string effectiveDirectory: FileUtils.trimFileProtocol(directory.toString())
    ...
    function apply(path, darkMode = Appearance.m3colors.darkmode) {
        ...
        Quickshell.execDetached([Directories.wallpaperSwitchScriptPathv2, darkMode ? "--dark" : "--light", "--wall", path]);
        root.changed()
    }
