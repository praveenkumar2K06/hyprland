...
Singleton {
    ...
    m3colors: QtObject {
        property bool darkmode: Appearance.m3colors.m3background.hslLightness < 0.5
        property bool transparent: false
        property color m3background: MatugenColors.background
        property color m3onBackground: MatugenColors.on_background

        property color m3surface: MatugenColors.surface
        property color m3surfaceDim: MatugenColors.surface_dim
        property color m3surfaceBright: MatugenColors.surface_bright

        property color m3surfaceContainerLowest: MatugenColors.surface_container_lowest
        property color m3surfaceContainerLow: MatugenColors.surface_container_low
        property color m3surfaceContainer: MatugenColors.surface_container
        property color m3surfaceContainerHigh: MatugenColors.surface_container_high
        property color m3surfaceContainerHighest: MatugenColors.surface_container_highest

        property color m3onSurface: MatugenColors.on_surface
        property color m3surfaceVariant: MatugenColors.surface_variant
        property color m3onSurfaceVariant: MatugenColors.on_surface_variant

        property color m3inverseSurface: MatugenColors.inverse_surface
        property color m3inverseOnSurface: MatugenColors.inverse_on_surface
        property color m3outline: MatugenColors.outline
        property color m3outlineVariant: MatugenColors.outline_variant

        property color m3shadow: MatugenColors.shadow
        property color m3scrim: MatugenColors.scrim

        property color m3surfaceTint: MatugenColors.primary

        property color m3primary: MatugenColors.primary
        property color m3onPrimary: MatugenColors.on_primary
        property color m3primaryContainer: MatugenColors.primary_container
        property color m3onPrimaryContainer: MatugenColors.on_primary_container
        property color m3inversePrimary: MatugenColors.inverse_primary

        property color m3secondary: MatugenColors.secondary
        property color m3onSecondary: MatugenColors.on_secondary
        property color m3secondaryContainer: MatugenColors.secondary_container
        property color m3onSecondaryContainer: MatugenColors.on_secondary_container

        property color m3tertiary: MatugenColors.tertiary
        property color m3onTertiary: MatugenColors.on_tertiary
        property color m3tertiaryContainer: MatugenColors.tertiary_container
        property color m3onTertiaryContainer: MatugenColors.on_tertiary_container

        property color m3error: MatugenColors.error
        property color m3onError: MatugenColors.on_error
        property color m3errorContainer: MatugenColors.error_container
        property color m3onErrorContainer: MatugenColors.on_error_container

        property color m3primaryFixed: MatugenColors.primary_fixed
        property color m3primaryFixedDim: MatugenColors.primary_fixed_dim
        property color m3onPrimaryFixed: MatugenColors.on_primary_fixed
        property color m3onPrimaryFixedVariant: MatugenColors.on_primary_fixed_variant

        property color m3secondaryFixed: MatugenColors.secondary_fixed
        property color m3secondaryFixedDim: MatugenColors.secondary_fixed_dim
        property color m3onSecondaryFixed: MatugenColors.on_secondary_fixed
        property color m3onSecondaryFixedVariant: MatugenColors.on_secondary_fixed_variant

        property color m3tertiaryFixed: MatugenColors.tertiary_fixed
        property color m3tertiaryFixedDim: MatugenColors.tertiary_fixed_dim
        property color m3onTertiaryFixed: MatugenColors.on_tertiary_fixed
        property color m3onTertiaryFixedVariant: MatugenColors.on_tertiary_fixed_variant
    ...
    sizes: QtObject {
        ...
        property real sidebarWidthExtended: 560
        property real sidebarWidthExpanded: 520
