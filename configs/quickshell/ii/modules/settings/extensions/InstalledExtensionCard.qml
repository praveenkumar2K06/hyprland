            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ExtensionBadge {
                            icon: "link"
                            tooltip: "Custom URL — installed from a custom link"
                            visible: ext.isCustomUrl
                        }
                        ExtensionBadge {
                            icon: "folder"
                            tooltip: "Local path extension — files linked from your filesystem"
                            visible: ext.isLocal
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        RippleButton {
                            ...
                            contentItem: StyledText {
                                ...
                                text: updateChecking ? "..." : (updateAvailable ? "Update" : "Check for updates")
                                font.pixelSize: Appearance.font.pixelSize.smaller
                                color: Appearance.colors.colOnSecondaryContainer
                            }
                            onClicked: {
