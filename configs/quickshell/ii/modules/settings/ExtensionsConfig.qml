    ...
    ContentSection {
        ...
        ButtonGroup {
            ...
            GroupButtonWithIcon {
                ...
                StyledToolTip { text: "Developer documentation to develop extensions" }
            }
            ...
            GroupButtonWithIcon {
                ...
                StyledToolTip { text: "Install from custom URL (for developers)" }
            }

            GroupButtonWithTextField {
                buttonIcon: "search"
                buttonText: "Search extensions..."
                Layout.fillWidth: true
            ...
            GroupButtonWithIcon {
                ...
                StyledToolTip { text: "Refresh extension list" }
            }
        }
        ...
        ButtonGroup {
            ...
            GroupButtonWithTextField {
                id: customUrlField
                buttonIcon: "add"
                buttonText: "GitHub URL or local path"
                Layout.fillWidth: true
            ...
            GroupButtonWithIcon {
                ...
                StyledToolTip { text: "Install a custom extension" }
            }
        }

        NoticeBox {
            Layout.fillWidth: true
            text: "Extension system is in early beta stage. Please be cautious when installing extensions from untrusted sources and report any issues you encounter."
            ConfigSwitch {
                checked: Config.options.extensions.enable
                onClicked: Config.options.extensions.enable = !Config.options.extensions.enable
                StyledToolTip { text: "Enable/Disable extensions" }
            }
        }
